      ...
      <div class="container-fluid">
        <div class="card card-primary card-outline">
          <div class="card-header">
            ...
            <h3 class="card-title">Hallo Selamat Datang  <strong> <?= $_SESSION['nama']; ?> </h3></strong>
            <?php
              include 'koneksi.php'; 
               $admin  = mysqli_query($conn, "SELECT * FROM tbusers");
                $admin = mysqli_num_rows($admin);
              ?>
              <?php
              include 'koneksi.php';
                $anggota    = mysqli_query($conn, "SELECT * FROM tbanggota");
                $jmlanggota = mysqli_num_rows($anggota);
              ?>
              <?php
              include 'koneksi.php'; 
                $buku       = mysqli_query($conn, "SELECT * FROM tbbuku");
                $jmlbuku = mysqli_num_rows($buku);
              ?>
              <?php
              include 'koneksi.php'; 
